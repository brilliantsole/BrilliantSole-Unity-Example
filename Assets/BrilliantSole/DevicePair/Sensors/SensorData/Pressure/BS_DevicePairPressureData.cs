...
{
    public readonly Dictionary<BS_InsoleSide, BS_PressureSensorData[]> Sensors { get; }
    ...
    public BS_DevicePairPressureData(Dictionary<BS_InsoleSide, BS_PressureSensorData[]> sensors, float scaledSum, float normalizedSum, in Vector2? centerOfPressure, in Vector2? normalizedCenterOfPressure)
    {
        Sensors = sensors;
        ScaledSum = scaledSum;
